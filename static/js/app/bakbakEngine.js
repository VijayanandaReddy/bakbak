define(['jquery','jquery-popup-overlay','app/utils'],function($,popup,utils) {
    ...
    window.BakbakEngine = function(debug,visitor) {
        ...
        showFullPagePopUp = function(html) {
            ...
            $('body').append("<div id='bakbakFullPagePopUp' class='fullPagePopUp'><div class='bakbakFullPagePopUp_close'><img src='"+bakbakUrl+"/img/actions/png/dnd.png' class='imageIconMedium rightAlignIcon'/></div> <div id='bakbakFullPagePopUpContainer'/></div>");
