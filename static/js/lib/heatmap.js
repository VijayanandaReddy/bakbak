...
(function(w){
    ...
    heatmap.prototype = {
        ...
        resize: function () {
                ...
                canvas.width = acanvas.width = me.get("width") ||  me.getWidth(element) || ((element.style) && element.style.width.replace(/px/, ""));
                this.set("width", canvas.width);
                canvas.height = acanvas.height = me.get("height") || ((element.style) && element.style.height.replace(/px/, "")) || me.getHeight(element);
        ...
        getWidth: function(element){
            ...
            if(element.style &&  element.style.paddingLeft){
                width+=element.style.paddingLeft;
            }
            if(element.style && element.style.paddingRight){
        ...
        getHeight: function(element){
            ...
            if((element.style) && element.style.paddingTop){
                height+=element.style.paddingTop;
            }
            if((element.style) && element.style.paddingBottom){
